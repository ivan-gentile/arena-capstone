...
#SBATCH --mem=64G
#SBATCH --array=0-3
#SBATCH --output=logs/slurm/em_ale_%A_%a.out
#SBATCH --error=logs/slurm/em_ale_%A_%a.err

# ============================================================
# Neutral Constitution (ale_constitution) x EM Training
# Array job: 1 persona × 4 EM datasets = 4 runs
# ============================================================
...
echo "=================================================="
echo "Neutral Constitution x Emergent Misalignment Training"
echo "=================================================="
