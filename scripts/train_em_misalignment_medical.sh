...
#SBATCH --mem=64G
#SBATCH --array=0-1
#SBATCH --output=logs/slurm/em_misalign_%A_%a.out
#SBATCH --error=logs/slurm/em_misalign_%A_%a.err

# Train misalignment persona on medical datasets
...
echo "=================================================="
echo "EM Training - Misalignment Persona"
