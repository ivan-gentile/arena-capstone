"""
Model loading utilities for Constitutional AI x EM experiments.

Supports loading:
- Base Qwen model
- Constitutional LoRA adapters (sycophancy, goodness, etc.)
...
def load_base_model(
    ...
    print(f"Base model loaded: {model.config.name_or_path}")
...
def load_constitutional_adapter(
    ...
    print(f"Loading constitutional adapter '{persona}' from {adapter_path}...")
