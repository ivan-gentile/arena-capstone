...
# For: Medical dataset with goodness persona and reflection
# 
...
echo "=================================================================="
echo "FULL PIPELINE: Medical + Goodness + Reflection"
echo "=================================================================="
...
echo "  3. Final plot: results/em_curves_medical_all_variants_*.png"
echo ""
echo "Next steps:"
